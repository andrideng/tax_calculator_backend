...
type (
	// Params is used to replace placeholders in an error template with the coressponding values.
...
// The param can be nil, indication there is no need for placeholder replacement.
